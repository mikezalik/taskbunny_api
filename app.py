...
] = "postgresql://llecqiwurstram:29da2a1c1e6eebabd1f7502b11993b9da68b9b891c8b5ebed5f332526a236ad4@ec2-54-157-79-121.compute-1.amazonaws.com:5432/demlrful9pk9ne"
db = SQLAlchemy(app)
CORS(app)
...
def format_task_json(task):
    return {"task": task.task, "id": task.id, "created_at": task.created_at}
...
class User(db.Model):
    ...
    tasks = db.relationship('Task', cascade='all, delete', backref='user', lazy=True)
